<?php 
  ...
  $destino = "./backend/CRUD/inserir.php";
  ...
  if(!empty($_GET['id'])) {
    ...
    $destino = "./backend/CRUD/alterar.php";
  }
?>
            ...
            <div class="col-md-5">
              <form action="<?=$destino ?>" method="post" class="p-3">
                ...
                <div class="mb-3">
                    ...
                    <input value="<?php echo isset($produtos) ? $produtos['nomeProduto'] : "" ?>" type="text" name="nomeProduto" class="form-control">
                </div>
                 <div class="mb-3">
              ...
              ?>
                <tr>
                  ...
                  <td>
                    ...
                    <a href="<?php echo './backend/CRUD/excluir.php?id='. $coluna['id']   ?>" onclick="return confirm('Deseja REALMENTE excluir?')" > <i class="fa-solid fa-trash" style="color: rgb(255, 0, 0);"></i> </a>
