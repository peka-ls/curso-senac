...
$produtos = mysqli_query($conexao, "SELECT produto.*, mercado.nome FROM produto INNER JOIN mercado ON mercado.id = produto.mercado_id ORDER BY produto.nome");
...
<body>
  ...
  <div id="carouselExample" class="carousel slide">
    <div class="carousel-inner">
      <div class="carousel-item active">
        <img src="assets/imagens/imagem1.png" class="d-block w-100" alt="...">
      </div>
      <div class="carousel-item">
        <img src="assets/imagens/imagem2.png" class="d-block w-100" alt="...">
      </div>
      <div class="carousel-item">
        <img src="assets/imagens/imagem3.png" class="d-block w-100" alt="...">
      </div>
    </div>
  ...
  <h2 class="text-center"> Bem Vindo ao <b style="color: oklch(85.2% 0.199 91.936);">ECOLOTE</b> </h2>
  ...
  <section style="background-color: #330672; margin-top: -5px; height: 150px; border-bottom: 5px solid oklch(85.2% 0.199 91.936);">
    <p class="text-center text-white" style="font-size: 20px; padding: 15px;">
      O Ecolote é um site que tem como objetivo, auxiliar pessoas a encontrarem produtos acessíveis, para assim, economizar dinheiro em suas compras e evitar o desperdício
    </p>
  </section>
        ...
        <div class="col-12 col-md-6 col-lg-3 mt-4 d-flex justify-content-center">
          <div class="card" style="width: 15rem;">
            ...
            <div class="card-body">
              ...
              <p class="card-text"> <?= $mercado['endereco']; ?> <br> <?= $mercado['telefone'] ?> </p>
              <a href="mercadoDetalhe.php?id=<?php echo $mercado['id'] ?>" class="btn btn-primary">acessar</a>
            </div>
          </div>
        </div>
      <?php } ?>
